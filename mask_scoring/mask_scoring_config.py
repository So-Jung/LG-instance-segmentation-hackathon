  #사용할 모델 선택
_base_ = '/content/lg_test/mmdetection/configs/ms_rcnn/ms_rcnn_x101_64x4d_fpn_1x_coco.py'
...
load_from = 'checkpoint/ms_rcnn_x101_64x4d_fpn_1x_coco_20200206-86ba88d2.pth'
